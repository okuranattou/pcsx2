...
void* mVUcompile(microVU& mVU, u32 startPC, uptr pState)
{
	...
	for (; x < endCount; x++)
	{
		if (isVU1 && (
			...
			xPC == 0x0170 || xPC == 0x0178 || xPC == 0x0180 || xPC == 0x0188 || xPC == 0x01e8 ||
			xPC == 0x01b8 || xPC == 0x01c0 || xPC == 0x01c8 || xPC == 0x01d0 ||
			xPC == 0x0208 || xPC == 0x0230 || xPC == 0x0238 || xPC == 0x0248 || xPC == 0x0250 || xPC == 0x0258 || xPC == 0x02a8 || xPC == 0x02b0 || xPC == 0x02b8 || xPC == 0x02c0 ||
